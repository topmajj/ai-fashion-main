...
import { Camera, Sparkles, User, Image, Palette } from "lucide-react"

const mockPhotoshootResults = [
  {
    id: 1,
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/fashion-photoshoot-1-rYOdaz0YyyDR2hBEv1pIq1zNuevWuH.jpg",
  },
  {
    id: 2,
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/fashion-photoshoot-2-Qkg7BdqUT1n9uUp1QUDa2BkVgUdx5F.jpg",
  },
  {
    id: 3,
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/fashion-photoshoot-3-Ps62jPwvTrQyLidVnU9vLhmdjEjHwv.jpg",
  },
]
...
export function AnimatedFashionPhotoshoot() {
        ...
        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
          ...
          >
            {isGenerating ? (
              ...
              <>
                Generate AI Fashion Photoshoot
        ...
        {isGenerating && (
          ...
          >
            ...
            <div className="flex justify-between text-sm text-gray-500">
              ...
              <span>Setting Up Scene</span>
              <span>Capturing Photos</span>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <AnimatePresence>
        {showResults && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }}>
            <div className="mb-4">
              <h4 className="text-lg font-semibold mb-2">AI Generated Fashion Photoshoot</h4>
              <p className="text-sm text-gray-500">
                Here are your AI-generated fashion photographs, ready for your portfolio or marketing campaigns
              </p>
            </div>
            <div className="grid grid-cols-3 gap-4">
              {mockPhotoshootResults.map((photo, index) => (
                <motion.div
                  key={photo.id}
