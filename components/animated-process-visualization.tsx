...
import { Palette, Shirt, Sparkles, Wand2, Scissors, Layers } from "lucide-react"
...
export function AnimatedProcessVisualization() {
      ...
      <AnimatePresence>
        {showResults && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }}>
            <div className="mb-4">
              <h4 className="text-lg font-semibold mb-2">AI Generated Designs</h4>
              <p className="text-sm text-gray-500">
                Here are your AI-generated fashion designs, optimized for style and marketability
              </p>
            </div>
            <div className="grid grid-cols-3 gap-4">
              {mockGeneratedDesigns.map((design, index) => (
                <motion.div
                  key={design.id}
